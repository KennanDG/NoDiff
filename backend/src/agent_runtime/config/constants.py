...
CODING_RUNTIME_FIELDS = (
    "coding_max_subtask_workers",
    "coding_max_implementation_units",
    "coding_max_patch_retries_per_unit",
    "coding_max_implementation_iterations",
    "coding_route_max_tokens",
    "coding_planner_max_tokens",
    "coding_repo_navigation_max_tokens",
    "coding_simple_patch_max_tokens",
    "coding_reconciliation_max_tokens",
    "coding_reconciliation_context_max_tokens",
    "coding_max_reasoning_reconciliations",
    "coding_context_prompt_base_tokens",
    "coding_max_context_prompt_tokens",
    "coding_context_prompt_reserve_tokens",
    "coding_context_window_safety_tokens",
...
CODING_RUNTIME_BOUNDS = {
    "coding_max_subtask_workers": (1, 6),
    "coding_max_implementation_units": (1, 12),
    "coding_max_patch_retries_per_unit": (0, 4),
    "coding_max_implementation_iterations": (1, 8),
    ...
    "coding_reconciliation_max_tokens": (2_000, 32_000),
    "coding_reconciliation_context_max_tokens": (4_000, 64_000),
    "coding_max_reasoning_reconciliations": (0, 3),
    "coding_context_prompt_base_tokens": (4_000, 64_000),
    "coding_max_context_prompt_tokens": (8_000, 128_000),
    "coding_context_prompt_reserve_tokens": (2_000, 64_000),
    "coding_context_window_safety_tokens": (1_000, 32_000),
    "coding_model_context_window_tokens": (16_000, 2_000_000),
    "reasoning_model_context_window_tokens": (16_000, 2_000_000),
    "coding_model_max_output_tokens": (2_000, 128_000),
    "reasoning_model_max_output_tokens": (2_000, 128_000),
}
