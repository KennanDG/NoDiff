...
from agent_runtime.agents.coding.utils.constants import (
    MAX_REPO_NAVIGATION_FILES,
    VALIDATION_PROFILE_NAME,
)

from agent_runtime.agents.coding.llm import invoke_parsed_decision
from agent_runtime.agents.coding.memory import recall_coding_memories, remember_coding_run
from agent_runtime.agents.coding.prompts import (
...
from agent_runtime.config.settings import settings as app_settings
from agent_runtime.agents.coding.runtime import repo_root as resolve_repo_root
from agent_runtime.agents.coding.coding_agent_schemas import (
    PlanDecision,
    RepoNavigationDecision,
    SkillRouteDecision,
)

from agent_runtime.agents.coding.utils.search import (
    filter_context_paths,
    paths_from_ranked_results,
)

from agent_runtime.agents.coding.coding_agent_settings import CodingAgentSettings, settings as default_settings
from agent_runtime.agents.coding.utils.skills import skill_instructions_for_llm
from agent_runtime.agents.coding.state import CodingAgentState
from agent_runtime.agents.coding.tests.runner import run_validation_suite
from agent_runtime.agents.coding.utils.text import bullets, dedupe
from agent_runtime.agents.coding.tools.filesystem import list_files, read_file
from agent_runtime.agents.coding.tools.web_search import web_search
from agent_runtime.agents.coding.tools.search import search_repository

from agent_runtime.agents.coding.utils.validation import (
...
from agent_runtime.agents.coding.utils.helpers import(
...
def _repo_path_variants(candidate: str, repo_files: list[str]) -> list[str]:
    ...
    The coding API already runs with repo_root at ``.../src/agent_runtime``. Voice/model
    handoffs sometimes repeat ``src/agent_runtime`` or ``agent_runtime`` in front of an
