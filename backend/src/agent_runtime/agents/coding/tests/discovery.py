...
from agent_runtime.agents.coding.tests.results import ValidationCommand
...
def _candidate_test_paths(source_path: Path) -> list[Path]:
    """
    Example:
    agent_runtime/agents/coding/graph.py
    -> tests/test_graph.py
    -> agent_runtime/agents/coding/tests/test_graph.py
    """
